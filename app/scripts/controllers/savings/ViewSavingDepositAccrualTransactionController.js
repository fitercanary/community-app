(function (module) {
    mifosX.controllers = _.extend(module, {
        ...
        scope.getSavingsAccruals = function (pageNumber) {
           var items =  resourceFactory.savingsResource.get({accountId: location.search().savingsId, associations: 'accrualTransactions',
        ...
        scope.getFixedDepositAccruals = function (pageNumber) {
           resourceFactory.fixedDepositAccountResource.get({accountId: location.search().fixedDepositId, associations: 'accrualTransactions',
           pageNumber : pageNumber, pageSize: scope.transactionsPerPage}, function (data) {
                 scope.savingaccountdetails = data;
                 scope.convertDateArrayToObject('date');
                 if(scope.savingaccountdetails.transactions){
        ...
        scope.getRecurringDepositAccruals = function (pageNumber) {
            resourceFactory.recurringDepositAccountResource.get({accountId: location.search().recurringDepositId, associations: 'accrualTransactions',
             pageNumber : pageNumber, pageSize: scope.transactionsPerPage}, function (data) {
                    scope.savingaccountdetails = data;
                    scope.convertDateArrayToObject('date');
                   if(scope.savingaccountdetails.transactions){
